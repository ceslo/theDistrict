...
// $("#aff_cat").remove();
// console.log(data.categorie.id_categorie);
// console.log(data.plat.id_categorie);

// if (data.plat.id_categorie == data.categorie.id_categorie){
//       console_log(data.plat.libelle)
//      };
