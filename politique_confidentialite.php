...
Chez e-Resto, notre mission est d’aider les restaurateurs à augmenter leur chiffre d’affaires, en proposant leurs plats à la vente à emporter, ou en livraison, par l’intermédiaire d’un service de click and collect personnalisé et intuitif. Si nous nous engageons à créer ainsi une grande communauté alimentaire, nous nous devons de protéger la vie privée des membres de cette communauté e-Resto. Cette protection inclut la protection des données personnelles de tous les visiteurs et utilisateurs du site internet, ainsi que des autres extensions (application mobile, espace restaurateur, espace client).
...
Soyez assuré qu’e-Resto s’est engagé à collecter et utiliser vos données personnelles de manière responsable, sécurisée et en toute transparence. Si vous avez le moindre doute, ou une question, contactez-nous à alex@e-resto.fr.
1. Informations que nous collectons sur vous, et les raisons de cette collecte

Si vous souhaitez obtenir de plus amples informations sur une section particulière, vous pouvez nous contacter.

Lorsque vous rejoignez e-Resto, nous collectons les informations d’enregistrement, afin que nous puissions :
...
Commentaires, axes d’amélioration, et autres informations essentielles
    ...
    Etudier, analyser, développer et améliorer nos services
    Informations sur votre activité sur le site e-resto.

Vous êtes informés que nous utilisons des cookies et technologies similaires afin de mesurer et analyser l’efficacité de nos services, personnaliser et optimiser notre communication, vous fournir des services géolocalisés.

Nous traitons des informations que vous nous fournissez volontairement, ainsi que des informations que nous collectons de manière automatique, ou que nous pouvons obtenir de sources tierces. La collecte et le traitement de ces informations servent à améliorer quotidiennement nos services, faciliter son utilisation et sa performance.
...
Chez e-Resto, nous accordons une grande importance à la sécurité et la protection de vos données personnelles, notamment contre tout accès non autorisé, tout traitement illégal, destruction, perte. Notre équipe technique met en oeuvre des mesures afin de garantir la sécurité de vos informations.
5. Conservation des données

Chez e-Resto, nous conservons l’ensemble de vos données le temps nécessaire pour satisfaire aux finalités décrites dans cette Politique de Confidentialité. Par exemple, toute la période durant laquelle votre Restaurant est référencé et présent sur notre plateforme. Dans le cadre de la tenue de nos dossiers, et le respect de nos obligations légales, nous pouvons être à-même de conserver certains éléments de vos données personnelles pour une période ultérieure à votre désactivation et suppression de compte.
6. Droits relatifs à la protection de vos données

Vous êtes en droit de nous contacter afin de nous demander de supprimer vos données personnelles ou de limiter leur traitement. Pour se faire, vous pouvez nous contacter sur : alex@e-resto.fr.
7. Liens vers d’autres sites

Chez e-Resto, nous sommes et serons amenés à réaliser des partenariats stratégiques, des liens d’affiliation avec des annonceurs et autres partenaires de différents secteurs. Nos sites web et espaces personnels peuvent donc contenir des liens vers des sites tiers. Si vous suivez ces liens, sachez qu’e-Resto n’est pas responsable de ces sites, qui ont leurs propres Politiques de confidentialité, et mènent leurs propres politiques commerciales.
8. Mise à jour de cette Politique de Confidentialité
...
9. Coordonnées pour nous contacter

Pour toute question, demande d’informations supplémentaires, ou préoccupation concernant notre Politique de Confidentialité ou nos services, vous pouvez nous contacter sur : alex@e-resto.fr.
